<x-splade-modal class="font-main">
    ...
    <x-splade-form class="flex flex-col space-y-4" action="{{route('admin.categories.store')}}" method="post">
          ...
          <x-splade-select label="{{__('parent')}}" placeholder="Parent id" name="parent_id" remote-url="/admin/categories/api" remote-root="model.data" option-label=name option-`value=`"id" choices/>
